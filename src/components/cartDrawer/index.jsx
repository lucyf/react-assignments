...
const CartDrawerComponent = () =>{
    ...
    return (
        ...
        <div className="m-3 p-3">
            ...
            <hr/>
            {condition ? <div>
                <h6 style={{opacity:0.5}}>Agrega un producto al carrito.</h6>
                </div> :
            <div id="all-cart-items">
                <div className="row">
                    ...
                    {cart.map((cart) => {
                        ...
                        <div className=" col">
                            <h6 className="m-1">{cart.item.item.name}</h6>
                            <p className="m-1" style={{opacity: 0.5}}>Cantidad: {cart.quantity}</p> 
